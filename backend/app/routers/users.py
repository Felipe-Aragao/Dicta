...
from app.core.authorization import require_user
...
def create_user(data: UserCreate, db: Session = Depends(get_db)):
    raise HTTPException(status_code=410, detail="Use /auth/register para criar usuários.")
...
def list_users(
    ...
    raise HTTPException(status_code=403, detail="Listagem de usuários não permitida.")
...
def get_user(
    ...
    current_user = require_user(context)
